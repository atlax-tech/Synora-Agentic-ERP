...
_TRANSITIONS: dict[str, frozenset[str]] = {
    # A confirmed P2P goal can move directly to proposal without running the
    # read-only analysis segment first.
    "CREATED": frozenset({"ANALYZING", "PROPOSED", "CANCELLED", "EXPIRED"}),

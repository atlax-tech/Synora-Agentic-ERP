...
code HEAD：`28cf8113f2c5ea48eb363c21c37ad0bc6514994e`；case SHA：`05d22c0ddc3617079d279d664a4422a541861af83c64fbb6d9edcc7e2a56acb7`。
deterministic fingerprint：`19a223af56bef86a434097eb033579ef07f1d63f1542500b26df89d4382a67b2`。
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| `single_agent` | 7/12 | 11/12 | 1/12 | 7/12 | 3396/5934 | 6043 | 12 | 0/0/0/0 |
| `planner_reviewer` | 6/12 | 12/12 | 0/12 | 6/12 | 14251/17539 | 14997 | 24 | 0/0/0/0 |
...
|---|---|---|---|---|---|
| `procurement_planner` | `REJECT` | `True` | `False` | `True` | real same-model A/B |
| `policy_risk_reviewer` | `REJECT` | `True` | `False` | `True` | real same-model A/B |

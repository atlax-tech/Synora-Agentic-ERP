...
状态：`BLOCKED`；arm：`real`；模型：`backup/grok-4.5`。
...
deterministic fingerprint：`7910337b8f1ba189e28f76cf7cccbdbc3d9d3f462bede20c39d89db2926ec0d4`。
threshold profile：`relative-model-v1`；completion cap：`512`；single baseline digest：`c23de24fbbc75ab2a1ced9c725f5832f331f30eb7d6f6f6548f4b3ed4c38645a`。
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| `single_agent` | 8/12 | 7/12 | 5/12 | 8/12 | 7910/60003 | 50745 | 10 | 0/0/0/0 |
| `planner_reviewer` | 8/12 | 10/12 | 2/12 | 8/12 | 10036/20055 | 111767 | 20 | 0/0/0/0 |
